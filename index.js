...
const helpContent = {
  ...
  quality: {
    header: "Quality",
    body: "Chất lượng đồ họa tổng thể. Nếu hoạt hình không chạy trơn tru, hãy thử giảm chất lượng. Chất lượng cao làm tăng đáng kể lượng tia lửa được hiển thị và có thể gây ra độ trễ.",
  },
  skyLighting: {
    header: "Sky Lighting",
